...
python "$func_root"/finalize_server_summary_email_html.py "$repo_root"/logs/TOTAL/"$cur_date" "$repo_root"/logs/TOTAL/"$cur_date"/summary_body.html "$repo_root"/setup/cdn.jupyter.org_notebook_5.1.0_style_style.min.css
